...
The template's default `pay_per_event.json` has one event `tool-request` priced at $0.05. Adjust the price and event taxonomy per a dedicated Apify monetization guide.
